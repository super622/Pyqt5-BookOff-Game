	...
	def get_products_list(self):
		try:
			...
			url_arr = [
				...
				f"https://www.amazon.co.jp/s?i=videogames&rh=n%3A637394%2Cn%3A8459821051&s=salesrank%7Bpage%7D&dc{page}&applicationType=BROWSER&deviceOS=Windows&handlerName=BrowsePage&pageId=637394&pageType=Browse&qid=1697520203&rnid=637394&softwareClass=Web+Browser&ref=sr_pg_{self.cur_page}",
